...
const Header = () => {
  return (
    <header className="flex items-center justify-between h-16 px-8 bg-[#f8f9fa] dark:bg-gray-900 border-b border-[#c6c6cd] dark:border-gray-700 sticky top-0 z-10 transition-all duration-200 w-full">
      ...
      <div className="flex items-center gap-4">
        ...
        <img className="w-8 h-8 rounded-full object-cover border border-[#c6c6cd] dark:border-gray-600 md:hidden" alt="Profile" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDh8a4ybwsndqNpsoxkvFJFkalMfzY_2GbtbuP6ujFZ1uAeuTmszJF1Zr9yTChoW1JPugirceM9JyMbPvbdoXfaPpOTn9Mw3aUkf6pxF51zq4RBVxUvCJOi4ygKj7_YknYsKLLc8GsugCt4INtm8UCxCTe5tJIB6YDvotGbi1HtU_0aGFGn4f1nmb6yym0dUY6c6I3D6Iy9I44jolqruE7f_I82ZJGXmc-P1aDBYr0PiPfiE9SGTSbSpQ" />
      </div>
    </header>
  );
};
