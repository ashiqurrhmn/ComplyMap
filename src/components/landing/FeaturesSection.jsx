...
const FeaturesSection = () => {
  ...
  return (
    <section ref={containerRef} id="features" className="py-24 bg-white dark:bg-[#07090e] transition-colors duration-300 relative overflow-hidden">
      {/* Background glow */}
      ...
      <div className="max-w-[1320px] mx-auto px-6 lg:px-10 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <h2 className="feature-header text-[36px] sm:text-[48px] font-extrabold text-gray-900 dark:text-white tracking-[-0.02em] leading-tight" style={{ fontFamily: "'Thunder', sans-serif", letterSpacing: "0.02em" }}>
          ...
          <p className="feature-header mt-4 text-[16px] text-gray-600 dark:text-white/40" style={{ fontFamily: "Inter, sans-serif" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6" style={{ fontFamily: "Inter, sans-serif" }}>
          {features.map((feature, idx) => (
            <div
              key={idx}
              className={`feature-card group relative p-8 rounded-3xl border border-gray-200 dark:border-white/[0.08] bg-white dark:bg-[#0c0f17] hover:border-[#006398]/30 dark:hover:border-white/[0.15] transition-colors duration-500 overflow-hidden ${feature.span}`}
            >
