...
const PricingSection = () => {
  return (
    <section id="pricing" className="py-24 bg-[#f8f9fa] dark:bg-[#07090e] border-y border-gray-200 dark:border-white/[0.04] transition-colors duration-300 relative overflow-hidden">
